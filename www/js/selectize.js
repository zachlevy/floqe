...
(function(root, factory) {
  ...
  var is_array = Array.isArray || (jQuery && jQuery.isArray) || function(object) {
...
(function(root, factory) {
...
}(this, function(jQuery, Sifter, MicroPlugin) {
  'use strict';
  ...
  var build_hash_table = function(key, objects) {
    if (!jQuery.isArray(objects)) return objects;
    var i, n, table = {};
  ...
  var Selectize = function($input, settings) {
    ...
    // build options table
    jQuery.extend(self.options, build_hash_table(settings.valueField, settings.options));
    delete self.settings.options;
  
    // build optgroup table
    jQuery.extend(self.optgroups, build_hash_table(settings.optgroupValueField, settings.optgroups));
  ...
  jQuery.extend(Selectize.prototype, {
    ...
    setup: function() {
      ...
      $control_input    = jQuery('<input type="text" autocomplete="off" />').appendTo($control).attr('tabindex', tab_index);
      $dropdown_parent  = jQuery(settings.dropdownParent || $wrapper);
      $dropdown         = jQuery('<div>').addClass(settings.dropdownClass).addClass(classes).addClass(inputMode).hide().appendTo($dropdown_parent);
    ...
    refreshOptions: function(triggerDropdown) {
      ...
      for (i = 0, n = groups_order.length; i < n; i++) {
        ...
        if (self.optgroups.hasOwnProperty(optgroup) && groups[optgroup].length) {
          ...
          html.push(self.render('optgroup', jQuery.extend({}, self.optgroups[optgroup], {
            html: html_children
          })));
        } else {
    ...
    createItem: function(triggerDropdown) {
      var self  = this;
      var input = jQuery.trim(self.$control_input.val() || '');
    ...
    insertAtCaret: function($el) {
      ...
      if (caret === 0) {
        ...
        jQuery(this.$control[0].childNodes[caret]).before($el);
      }
  ...
  jQuery.fn.selectize = function(settings_user) {
    ...
    var init_textbox = function($input, settings_element) {
      var i, n, values, option, value = jQuery.trim($input.val() || '');
      ...
      var addOption = function($option, group) {
        ...
        if (options.hasOwnProperty(value)) {
          if (group) {
            ...
            } else if (!jQuery.isArray(options[value].optgroup)) {
